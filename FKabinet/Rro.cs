...
namespace PgWpfApp2
{
    internal class Rro : PapaKabinet
    {
        ...
        private const string QKabinetRro = @"SELECT terminals.department,
...
ORDER BY terminals.termial;";
        ...
        internal static List<List<string>> GetKabinetRro() { return PgGetData(QKabinetRro); }
